...
public class UpdateAccount extends javax.swing.JDialog {
    ...
    private void btnupdateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnupdateMouseClicked
        ...
        // Kiểm tra email trùng với tài khoản khác (cho phép giữ nguyên email cũ)
        Account existEmail = DaoAccount.getInstance().selectByEmail(email);
        if (existEmail != null && !existEmail.getUser().equals(user)) {
        ...
        DaoAccount.getInstance().update(acc);
        this.dispose();
