...
public class CTPhieuXuat extends javax.swing.JDialog {
    ...
    public void loadDataToTableProduct() {
        try {
            ArrayList<ChiTietPhieu> CTPhieu = DaoChiTietPhieuXuat.getInstance().SelectBymaphieu(this.parent.getPhieuXuatSelect().getMaPhieu());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        WritePDF.exportWithChooser(this, tblChiTietPhieu, "Phiếu Xuất Hàng");
