...
public class ChangePassword extends javax.swing.JDialog {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (nameAccount.equals("") || emailAccount.equals("")) {
            JOptionPane.showMessageDialog(this, "Vui lòng nhập đầy đủ thông tin !");
        } else {
            if (isValid(emailAccount)) {
                Account existEmail = DaoAccount.getInstance().selectByEmail(emailAccount);
                if (existEmail != null && !existEmail.getUser().equals(accCur.getUser())) {
                    ...
                    DaoAccount.getInstance().update(accCur);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (check == true) {
            ...
            if (BCrypt.checkPassword(curPass, accCur.getPassword())) {
                if (newPass.length() < 6) {
                    JOptionPane.showMessageDialog(this, "Vui lòng nhập mật khẩu mới lớn bằng 6 kí tự");
                } else {
                    if (newPass.equals(newPassConf)) {
                        // Mã hóa mật khẩu mới trước khi lưu
                        String pass = BCrypt.hashPassword(passAft.getText());
