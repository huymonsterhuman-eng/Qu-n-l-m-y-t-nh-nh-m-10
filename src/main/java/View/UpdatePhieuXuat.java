...
public class UpdatePhieuXuat extends javax.swing.JDialog {
    ...
    public UpdatePhieuXuat(javax.swing.JInternalFrame parent, javax.swing.JFrame owner, boolean modal) throws UnsupportedLookAndFeelException {
        ...
        CTPhieu = DaoChiTietPhieuXuat.getInstance().SelectBymaphieu(phieuxuat.getMaPhieu());
        CTPhieuOld = DaoChiTietPhieuXuat.getInstance().SelectBymaphieu(phieuxuat.getMaPhieu());
        // Hien thi thong tin
        initTable();
    ...
    private void displayInfo() {
        ...
        txtNguoiTao.setText(DaoAccount.getInstance().selectById(phieuxuat.getNguoiTao()).getUser());
    }
    ...
    private void btnNhapHangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNhapHangActionPerformed
        ...
        if (CTPhieu.isEmpty()) {
            ...
            try {
                DaoPhieuXuat.getInstance().update(pn);
                DaoChiTietPhieuXuat.getInstance().delete(CTPhieuOld.get(CTPhieuOld.size() - 1));
                for (var i : CTPhieu) {
