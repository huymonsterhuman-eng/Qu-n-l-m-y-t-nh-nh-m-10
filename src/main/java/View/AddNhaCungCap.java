    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            if (maNcc.equals("") || tenNcc.equals("") || sdtNcc.equals("") || diachiNcc.equals("")) {
                ...
                // selectById trả về null nghĩa là mã chưa tồn tại → có thể thêm
                if (DaoNhaCungCap.getInstance().selectById(maNcc) == null) {
                    NhaCungCap ncc = new NhaCungCap();
                    ncc.setMaNhaCungCap(maNcc);
                    ncc.setTenNhaCungCap(tenNcc);
                    ncc.setSdt(sdtNcc);
                    ncc.setDiaChi(diachiNcc);
                    DaoNhaCungCap.getInstance().insert(ncc);
                    JOptionPane.showMessageDialog(this, "Thêm thành công !");
                    parent.loadDataToTable(DaoNhaCungCap.getInstance().selectAll());
                    this.dispose();
                } else {
