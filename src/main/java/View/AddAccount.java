...
public class AddAccount extends javax.swing.JDialog {
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        String password = BCrypt.hashPassword(txtpassword.getText());
        String role = vaitro.getSelectedItem().toString();
        String email = txtEmail.getText();
        if (fullName.equals("") || txtpassword.getText().equals("") || role.equals("") || email.equals("")) {
            JOptionPane.showMessageDialog(this, "Vui lòng nhập đầy đủ thông tin !", "Cảnh báo ", JOptionPane.WARNING_MESSAGE);
        } else {
            // Kiểm tra tên đăng nhập chưa tồn tại (selectById trả về null nghĩa là chưa có)
            if (DaoAccount.getInstance().selectById(user) == null) {
                if (DaoAccount.getInstance().selectByEmail(email) != null) {
                    JOptionPane.showMessageDialog(this, "Email đã được sử dụng bởi tài khoản khác!", "Cảnh báo", JOptionPane.WARNING_MESSAGE);
                } else if (isValid(email)) {
                    Account acc = new Account(fullName, user, password, role, 1, email);
                    DaoAccount.getInstance().insert(acc);
                    this.dispose();
                    homeAcc.loadDataToTable(DaoAccount.getInstance().selectAll());
