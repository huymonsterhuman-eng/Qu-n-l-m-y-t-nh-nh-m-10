...
public class AddProduct extends javax.swing.JDialog {
    ...
    public String createIdPC() {
        ArrayList<MayTinh> mtAll = Daomaytinh.getInstance().selectAll();
