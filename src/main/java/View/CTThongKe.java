...
public class CTThongKe extends javax.swing.JDialog {
    ...
    public CTThongKe(javax.swing.JInternalFrame parent, javax.swing.JFrame owner, boolean modal) {
        ...
        labelNguoiTao.setText(DaoAccount.getInstance().selectById(pn.getNguoiTao()).getFullname());
    ...
    public void loadDataToTableProduct() {
        try {
            ...
            if (check.contains("PX")) {
                ArrayList<ChiTietPhieu> CTPhieu = DaoChiTietPhieuXuat.getInstance().SelectBymaphieu(check);
                for (int i = 0; i < CTPhieu.size(); i++) {
                    tblCTPhieumd.addRow(new Object[]{
                        i + 1,
                        CTPhieu.get(i).getMaMay(),
                        Daomaytinh.getInstance().selectById(CTPhieu.get(i).getMaMay()).getTenMay(),
                ...
                ArrayList<ChiTietPhieu> CTPhieu = DaoChiTietPhieuNhap.getInstance().SelectBymaphieu(check);
                for (int i = 0; i < CTPhieu.size(); i++) {
                    tblCTPhieumd.addRow(new Object[]{
                        i + 1,
                        CTPhieu.get(i).getMaMay(),
    ...
    public ArrayList<Phieu> getPhieuAll() {
        ...
        ArrayList<PhieuNhap> conten1 = DaoPhieuNhap.getInstance().selectAll();
        ArrayList<Phieuxuat> conten2 = DaoPhieuXuat.getInstance().selectAll();
    ...
    private void btnExportPDFActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExportPDFActionPerformed
        ...
        WritePDF.exportWithChooser(this, tblChiTietPhieu, "Chi tiết phiếu - " + this.parent.findPhieu().getMaPhieu());
