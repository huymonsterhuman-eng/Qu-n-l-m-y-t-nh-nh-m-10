...
public class Admin extends javax.swing.JFrame {
    ...
    /**
     * Constructor chính — nhận tài khoản đã đăng nhập để dùng trong suốt phiên làm việc.
     *
     * @param t tài khoản vừa đăng nhập thành công từ Login
     */
    public Admin(Account t) throws UnsupportedLookAndFeelException {
        ...
        // Bật viền dọc/ngang cho tất cả JTable trong ứng dụng
        ...
        // Hiển thị họ tên người dùng trên navbar
        NameUser.setText(t.getFullname());

        // Mặc định mở form Sản Phẩm khi vừa vào Admin
        ProductForm pf = new ProductForm();
        MainContent.add(pf).setVisible(true);

        // Màu mặc định và màu item đang được chọn trên navbar
        DefaultColor = new Color(89, 168, 105);
        ClickedColor = new Color(26, 188, 156);

        // Đặt màu navbar, highlight tab Sản Phẩm vì đang mở mặc định
    ...
    private void onFrameResized() {
        ...
        if (w <= 0 || h <= 0) return;
        NavbarMenu.setBounds(0, 0, 240, h);
        MainContent.setBounds(240, 0, w - 240, h);
        for (java.awt.Component c : MainContent.getComponents()) {
            c.setSize(w - 240, h);
        }
    ...
    private void NhapHangMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_NhapHangMouseClicked
        // TODO add your handling code here:
        // Truyền username để ghi vào trường "Người tạo" trên phiếu nhập
    ...
    private void XuatHangMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_XuatHangMouseClicked
        // TODO add your handling code here:
        // Truyền họ tên đầy đủ để ghi vào trường "Người tạo" trên phiếu xuất
    ...
    /**
     * Cập nhật tên người dùng hiển thị trên navbar.
     * Được gọi từ Login sau khi đăng nhập thành công.
     *
     * @param name họ tên đầy đủ của tài khoản
     */
